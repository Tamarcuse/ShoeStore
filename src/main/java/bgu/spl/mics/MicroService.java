...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class<? extends Message>, Callback> msgType2Callback;
    private ConcurrentHashMap<Request, Callback> reqComp2Callback;
    ...
    protected final <R extends Request> void subscribeRequest(Class<R> type, Callback<R> callback) {
    	...
    	msgType2Callback.putIfAbsent(type, callback);   	
    }
    ...
    protected final <T> boolean sendRequest(Request<T> r, Callback<T> onComplete) {
    	reqComp2Callback.putIfAbsent(r, onComplete);
